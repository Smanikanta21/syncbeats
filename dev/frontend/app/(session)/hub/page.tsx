...
export default function HubPage() {
  ...
  function DeviceGlyph({ userAgent }: { userAgent: string | null }) {
    if (userAgent?.includes("iPhone") || userAgent?.includes("Android")) return <Smartphone className={cn('w-4', 'h-4', 'text-foreground/70')} />;
    return <Laptop className={cn('w-4', 'h-4', 'text-foreground/70')} />;
  }
  ...
  return (
    <div className={cn('min-h-screen', 'relative', 'px-4', 'sm:px-6', 'lg:px-8', 'z-0', 'bg-transparent', 'text-foreground', 'transition-colors', 'duration-300')}>
      {/* Main Hub Content */}
      <main className={cn('w-full', 'max-w-4xl', 'mx-auto', 'pb-20', 'pt-4')}>

        <div className={cn('text-center', 'mb-16')}>
          <h1 className={cn('text-4xl', 'md:text-5xl', 'font-black', 'mb-4', 'text-foreground', 'animate-fade-in-up')}>
            What&apos;s the move?
          </h1>
          <p className={cn('text-foreground/60', 'text-lg', 'font-medium', 'tracking-wide', 'animate-fade-in-up-delay')}>
        ...
        <div className={cn('grid', 'grid-cols-1', 'md:grid-cols-2', 'gap-8', 'w-full', 'max-w-4xl', 'mx-auto', 'relative', 'z-10')}>
          ...
          >
            ...
            <Magnetic className={cn('w-full', 'mt-auto')}>
              <button
                onClick={handleHost}
                disabled={isHosting}
          ...
          >
            ...
            <form onSubmit={handleJoin} className={cn('mt-auto', 'w-full', 'relative')}>
              <input
                type="text"
                maxLength={6}
                value={joinCode}
        ...
        <motion.div
          ...
          className={cn('mt-20', 'w-full', 'max-w-4xl', 'mx-auto')}
        >
          <div className={cn('flex', 'items-center', 'gap-2', 'mb-6', 'ml-2')}>
            <Clock className={cn('w-4', 'h-4', 'text-foreground/60')} />
            <h2 className={cn('text-sm', 'font-semibold', 'tracking-widest', 'text-foreground/60', 'uppercase')}>Recent Sessions</h2>
          </div>

          {invitedRooms.length > 0 && (
            <div className="mb-8">
              <h3 className={cn('text-xs', 'font-bold', 'tracking-widest', 'text-foreground/40', 'uppercase', 'mb-3', 'ml-2')}>Invited</h3>
              <div className={cn('grid', 'grid-cols-1', 'sm:grid-cols-2', 'md:grid-cols-3', 'gap-4')}>
                {invitedRooms.map((room) => (
                  <div
                    key={room.inviteId}
                    onClick={() => window.open(`/room/${room.id}`, '_blank')}
                    className={cn('glass-panel', 'p-4', 'rounded-2xl', 'border', 'border-blue-500/30', 'bg-blue-500/5', 'hover:bg-blue-500/10', 'flex', 'items-center', 'justify-between', 'cursor-pointer', 'transition-colors', 'group', 'relative', 'overflow-hidden')}
                  >
                    <div className={cn('absolute', 'top-0', 'right-0', 'px-2', 'py-0.5', 'bg-blue-500', 'text-white', 'text-[9px]', 'font-bold', 'tracking-widest', 'rounded-bl-lg')}>INVITED</div>
                    <div className={cn('flex', 'items-center', 'gap-3')}>
                      <div className={cn('w-10', 'h-10', 'rounded-full', 'bg-blue-500/20', 'flex', 'items-center', 'justify-center')}>
                        <Play className={cn('w-4', 'h-4', 'text-blue-400', 'group-hover:text-blue-300', 'transition-colors')} />
                      </div>
                      <div>
                        <div className={cn('text-sm', 'font-bold', 'text-blue-300', 'font-mono', 'tracking-widest')}>{room.id}</div>
                        <div className={cn('text-xs', 'text-foreground/50', 'mt-0.5')}>Invited by {room.inviterName}</div>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          {recentRooms.length === 0 ? (
            <p className={cn('text-foreground/40', 'text-sm', 'font-medium', 'text-center', 'py-8')}>
            ...
            <div className={cn('grid', 'grid-cols-1', 'sm:grid-cols-2', 'md:grid-cols-3', 'gap-4')}>
              {recentRooms.map((room) => (
                <div
                  ...
                  className={cn('glass-panel', 'p-4', 'rounded-2xl', 'border', 'border-foreground/5', 'bg-foreground/5', 'hover:bg-foreground/10', 'flex', 'items-center', 'justify-between', 'cursor-pointer', 'transition-colors', 'group')}
                >
                  <div className={cn('flex', 'items-center', 'gap-3')}>
                    <div className={cn('w-10', 'h-10', 'rounded-full', 'bg-foreground/10', 'flex', 'items-center', 'justify-center')}>
                      {room.ended_at
                        ? <Disc className={cn('w-5', 'h-5', 'text-foreground/40')} />
                        : <Play className={cn('w-4', 'h-4', 'text-foreground/60', 'group-hover:text-foreground', 'transition-colors')} />
                      }
                    </div>
                    <div>
                      <div className={cn('text-sm', 'font-bold', 'text-foreground/70', 'font-mono', 'tracking-widest')}>{room.id}</div>
                  ...
                  <div className={cn('flex', 'items-center', 'gap-2')}>
                    <button
                      ...
                      className={cn('md:hidden', 'h-8', 'w-8', 'rounded-lg', 'border', 'border-foreground/10', 'bg-foreground/5', 'text-foreground/60', 'hover:text-foreground', 'hover:bg-foreground/10', 'transition-colors')}
                    >
                      <MoreHorizontal className={cn('w-4', 'h-4', 'mx-auto')} />
                    </button>
                    <ArrowRight className={cn('w-4', 'h-4', 'text-foreground/40', 'group-hover:text-foreground/60', 'transition-colors')} />
                  </div>
                </div>
              ))}
            </div>
        ...
        <motion.div
          ...
          className={cn('mt-10', 'w-full', 'max-w-5xl', 'mx-auto')}
        >
          <div className={cn('flex', 'items-center', 'justify-between', 'gap-4', 'mb-6', 'ml-2')}>
            <div>
              <p className={cn('text-xs', 'font-bold', 'uppercase', 'tracking-[0.3em]', 'text-foreground/60')}>Devices</p>
              <h2 className={cn('text-sm', 'font-semibold', 'tracking-widest', 'text-foreground/60', 'uppercase', 'mt-1')}>Your saved devices</h2>
            </div>
            <div className={cn('text-sm', 'text-foreground/60', 'font-medium')}>{devices.length} saved</div>
          </div>

          {devices.length === 0 ? (
            <p className={cn('text-foreground/40', 'text-sm', 'font-medium', 'text-center', 'py-8')}>No devices saved yet.</p>
          ) : (
                ...
                return (
                  ...
                  >
                    <div className={cn('flex', 'items-center', 'gap-3', 'min-w-0', 'flex-1')}>
                      <div className={cn('w-10', 'h-10', 'rounded-full', 'bg-foreground/10', 'flex', 'items-center', 'justify-center', 'shrink-0')}>
                        <DeviceGlyph userAgent={savedDevice.user_agent} />
                      </div>
                      <div className={cn('min-w-0', 'flex-1')}>
                        <div className={cn('flex', 'items-center', 'gap-2', 'min-w-0', 'mb-0.5')}>
                          ...
                          <span className={cn('text-sm', 'font-bold', 'text-foreground', 'truncate', 'block')} title={savedDevice.name}>
                            {savedDevice.name}
                          </span>
                          {isCurrent && <span className={cn('px-2', 'py-0.5', 'rounded-full', 'bg-green-500/15', 'text-green-400', 'text-[10px]', 'font-black', 'uppercase', 'tracking-widest', 'shrink-0')}>Current</span>}
                        </div>
                        <div className={cn('text-xs', 'text-foreground/40', 'font-medium', 'truncate')}>{getPlatformLabel(savedDevice.user_agent)}</div>
                      </div>
                    </div>
                    <button
                      onClick={(event) => {
                      ...
                      className={cn('h-10', 'w-12', 'shrink-0', 'rounded-lg', 'border', 'border-foreground/10', 'bg-foreground/5', 'text-foreground/60', 'hover:text-foreground', 'hover:bg-foreground/10', 'transition-colors')}
                    >
                      <MoreHorizontal className={cn('w-4', 'h-4', 'mx-auto')} />
                    </button>
                  </div>
        ...
        {roomMenu && (
          <>
            ...
            <div className={cn('md:hidden', 'fixed', 'inset-0', 'z-[80]', 'bg-background/45', 'backdrop-blur-sm', 'flex', 'items-end')} onClick={() => setRoomMenu(null)}>
              <motion.div
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "100%" }}
              ...
              >
                ...
                <h2 className={cn('text-lg', 'font-black', 'text-foreground', 'text-center', 'mb-1')}>Room Settings</h2>
                <p className={cn('text-xs', 'text-foreground/40', 'font-mono', 'text-center', 'tracking-widest', 'uppercase', 'mb-2')}>Room: {roomMenu.room.id}</p>
                ...
                <div className={cn('flex', 'flex-col', 'gap-2.5')}>
                  {roomMenu.room.host_id === user?.id && (
                    ...
                    >
                      <Trash2 className={cn('w-5', 'h-5', 'text-red-400')} />
                      End session
                    </button>
                  )}
                  <button
                    ...
                    className={cn('w-full', 'text-left', 'px-4', 'py-3.5', 'rounded-2xl', 'text-foreground', 'hover:bg-foreground/5', 'text-base', 'font-bold', 'flex', 'items-center', 'gap-3', 'border', 'border-foreground/5', 'bg-foreground/2', 'active:scale-[0.99]', 'transition-all')}
                  >
                    <QrCode className={cn('w-5', 'h-5', 'text-foreground/70')} />
                    Room info + QR
                  </button>
                  {roomMenu.room.host_id === user?.id && (
                    <button
                      ...
                      className={cn('w-full', 'text-left', 'px-4', 'py-3.5', 'rounded-2xl', 'text-foreground', 'hover:bg-foreground/5', 'text-base', 'font-bold', 'flex', 'items-center', 'gap-3', 'border', 'border-foreground/5', 'bg-foreground/2', 'active:scale-[0.99]', 'transition-all')}
                    >
                      <UserRoundCog className={cn('w-5', 'h-5', 'text-foreground/70')} />
                      Change host
                    </button>
                  )}
                </div>
            ...
            <div
              className={cn('hidden', 'md:block', 'fixed', 'z-[80]', 'min-w-55', 'rounded-2xl', 'border', 'border-foreground/10', 'bg-background/95', 'p-2', 'shadow-2xl')}
              style={{
            ...
            >
              ...
              <button
                ...
                className={cn('w-full', 'text-left', 'px-3', 'py-2', 'rounded-xl', 'text-foreground', 'hover:bg-foreground/10', 'text-sm', 'font-medium', 'flex', 'items-center', 'gap-2')}
              >
                <QrCode className={cn('w-4', 'h-4', 'text-foreground/70')} />
                Room info + QR
              </button>
              {roomMenu.room.host_id === user?.id && (
                <button
                  ...
                  className={cn('w-full', 'text-left', 'px-3', 'py-2', 'rounded-xl', 'text-foreground', 'hover:bg-foreground/10', 'text-sm', 'font-medium', 'flex', 'items-center', 'gap-2')}
                >
                  <UserRoundCog className={cn('w-4', 'h-4', 'text-foreground/70')} />
                  Change host
                </button>
              )}
            </div>
        ...
        {deviceMenu && (
          <>
            {/* Mobile Bottom Sheet Menu */}
            <div className={cn('md:hidden', 'fixed', 'inset-0', 'z-[80]', 'bg-background/45', 'backdrop-blur-sm', 'flex', 'items-end')} onClick={() => setDeviceMenu(null)}>
              <motion.div
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "100%" }}
              ...
              >
                <div className={cn('w-12', 'h-1.5', 'rounded-full', 'bg-foreground/20', 'mx-auto', 'mb-2')} />
                <h2 className={cn('text-lg', 'font-black', 'text-foreground', 'text-center', 'mb-1')}>Device Settings</h2>
                <p className={cn('text-xs', 'text-foreground/40', 'font-mono', 'text-center', 'tracking-widest', 'uppercase', 'mb-2')}>Device: {deviceMenu.device.name}</p>
        ...
        {roomToEnd && (
          <div className={cn('fixed', 'inset-0', 'z-[85]', 'flex', 'items-center', 'justify-center', 'bg-background/70', 'backdrop-blur-xl', 'px-4')}>
            <div className={cn('w-full', 'max-w-md', 'rounded-4xl', 'border', 'border-foreground/10', 'bg-background', 'p-6', 'shadow-[0_30px_120px_rgba(0,0,0,0.7)]')}>
              <div className={cn('flex', 'items-center', 'justify-between', 'mb-6')}>
                <h2 className={cn('text-2xl', 'font-black', 'text-foreground')}>End Session?</h2>
                <button onClick={() => setRoomToEnd(null)} aria-label="Close" className={cn('text-foreground/60', 'hover:text-foreground')}><X className={cn('w-5', 'h-5')} /></button>
              </div>
              <p className={cn('text-foreground/60', 'text-sm', 'mb-6')}>
                Do you really want to end session <span className={cn('font-mono', 'text-foreground')}>{roomToEnd.id}</span>?
              </p>
              <div className={cn('flex', 'items-center', 'gap-3')}>
                <button onClick={() => setRoomToEnd(null)} className={cn('h-11', 'flex-1', 'rounded-2xl', 'border', 'border-foreground/10', 'bg-foreground/5', 'text-foreground', 'font-semibold')}>No</button>
                <button onClick={handleConfirmEndSession} className={cn('h-11', 'flex-1', 'rounded-2xl', 'bg-red-500', 'text-white', 'font-semibold')}>Yes, end</button>
              </div>
            </div>
          </div>
        )}
        ...
        {roomInfo && (
          <div className={cn('fixed', 'inset-0', 'z-[85]', 'flex', 'items-center', 'justify-center', 'bg-background/70', 'backdrop-blur-xl', 'px-4')}>
            <div className={cn('w-full', 'max-w-md', 'rounded-4xl', 'border', 'border-foreground/10', 'bg-background', 'p-6', 'shadow-[0_30px_120px_rgba(0,0,0,0.7)]')}>
              <div className={cn('flex', 'items-center', 'justify-between', 'mb-6')}>
                <h2 className={cn('text-2xl', 'font-black', 'text-foreground')}>Room Info</h2>
                <button onClick={() => setRoomInfo(null)} aria-label="Close" className={cn('text-foreground/60', 'hover:text-foreground')}><X className={cn('w-5', 'h-5')} /></button>
              </div>

              <div className={cn('rounded-2xl', 'border', 'border-foreground/10', 'bg-background', 'p-4', 'w-fit', 'mx-auto', 'mb-5')}>
                <Image src={qrSrc} alt={`QR code for room ${roomInfo.id}`} width={224} height={224} className={cn('w-56', 'h-56')} unoptimized />
              </div>

              <div className="space-y-3">
                <div className={cn('rounded-xl', 'border', 'border-foreground/10', 'bg-foreground/5', 'p-3')}>
                  <p className={cn('text-xs', 'text-foreground/60', 'uppercase', 'tracking-widest', 'mb-1')}>Room Code</p>
                  <p className={cn('font-mono', 'text-foreground', 'tracking-widest')}>{roomInfo.id}</p>
                </div>
                <div className={cn('rounded-xl', 'border', 'border-foreground/10', 'bg-foreground/5', 'p-3')}>
                  <p className={cn('text-xs', 'text-foreground/60', 'uppercase', 'tracking-widest', 'mb-1')}>Room Link</p>
                  <p className={cn('text-foreground/70', 'text-sm', 'break-all')}>{roomLink}</p>
                </div>
                <button
                  onClick={handleCopyRoomLink}
                  className={cn('w-full', 'h-11', 'rounded-2xl', 'border', 'border-foreground/10', 'bg-foreground/5', 'text-foreground', 'font-semibold', 'flex', 'items-center', 'justify-center', 'gap-2', 'hover:bg-foreground/10', 'transition-colors')}
                >
        ...
        {roomToTransfer && (
          <div className={cn('fixed', 'inset-0', 'z-[85]', 'flex', 'items-center', 'justify-center', 'bg-background/70', 'backdrop-blur-xl', 'px-4')}>
            <div className={cn('w-full', 'max-w-md', 'rounded-4xl', 'border', 'border-foreground/10', 'bg-background', 'p-6', 'shadow-[0_30px_120px_rgba(0,0,0,0.7)]')}>
              <div className={cn('flex', 'items-center', 'justify-between', 'mb-6')}>
                <h2 className={cn('text-2xl', 'font-black', 'text-foreground')}>Change Host</h2>
                <button onClick={() => setRoomToTransfer(null)} aria-label="Close" className={cn('text-foreground/60', 'hover:text-foreground')}><X className={cn('w-5', 'h-5')} /></button>
              </div>

              <p className={cn('text-foreground/60', 'text-sm', 'mb-4')}>
                Enter the email of the user who should become host for <span className={cn('font-mono', 'text-foreground')}>{roomToTransfer.id}</span>.
              </p>
              ...
              <form className="space-y-4" onSubmit={handleChangeHost}>
                <input
                  ...
                  className={cn('w-full', 'bg-foreground/5', 'border', 'border-foreground/10', 'rounded-xl', 'px-4', 'py-3', 'text-foreground', 'outline-none', 'transition-all', 'placeholder:text-foreground/40', 'focus:border-foreground/30', 'focus:ring-1', 'focus:ring-foreground/30')}
                />
                <button
                  disabled={isTransferringHost || !newHostEmail.trim()}
                  className={cn('h-11', 'w-full', 'rounded-2xl', 'bg-foreground', 'text-background', 'font-semibold', 'disabled:opacity-60', 'disabled:cursor-not-allowed')}
                >
        ...
        {showDeviceRename && (
          <div className={cn('fixed', 'inset-0', 'z-[85]', 'flex', 'items-center', 'justify-center', 'bg-background/70', 'backdrop-blur-xl', 'px-4')}>
            <div className={cn('w-full', 'max-w-md', 'rounded-4xl', 'border', 'border-foreground/10', 'bg-background', 'p-6', 'shadow-[0_30px_120px_rgba(0,0,0,0.7)]')}>
              <div className={cn('flex', 'items-center', 'justify-between', 'mb-6')}>
                <h2 className={cn('text-2xl', 'font-black', 'text-foreground')}>Rename Device</h2>
                <button onClick={() => setShowDeviceRename(false)} aria-label="Close" className={cn('text-foreground/60', 'hover:text-foreground')}><X className={cn('w-5', 'h-5')} /></button>
              </div>
              <form className="space-y-4" onSubmit={handleDeviceRename}>
                {(() => {
                  const dev = devices.find(d => d.id === editingDeviceId);
                  return dev ? (
                    <div className={cn('flex', 'items-center', 'gap-3', 'mb-4', 'p-3.5', 'rounded-2xl', 'border', 'border-foreground/10', 'bg-foreground/5')}>
                      <div className={cn('w-8', 'h-8', 'rounded-full', 'bg-background', 'flex', 'items-center', 'justify-center', 'shrink-0', 'shadow-sm', 'border', 'border-foreground/5')}>
                        <DeviceGlyph userAgent={dev.user_agent} />
                      </div>
                      <div className={cn('flex', 'flex-col')}>
                        <span className={cn('text-xs', 'font-bold', 'uppercase', 'tracking-widest', 'text-foreground/40')}>Detected Type</span>
                        <span className={cn('text-sm', 'text-foreground', 'font-semibold')}>
        ...
        {showScanner && (
          <div className={cn('fixed', 'inset-0', 'z-[90]', 'flex', 'items-center', 'justify-center', 'bg-background/80', 'backdrop-blur-xl', 'px-4')}>
            <div className={cn('w-full', 'max-w-md', 'rounded-4xl', 'border', 'border-foreground/10', 'bg-background', 'p-5', 'shadow-[0_30px_120px_rgba(0,0,0,0.7)]')}>
              <div className={cn('flex', 'items-center', 'justify-between', 'mb-4')}>
                <h2 className={cn('text-xl', 'font-black', 'text-foreground')}>Scan Room QR</h2>
                <button onClick={stopScanner} aria-label="Close" className={cn('text-foreground/60', 'hover:text-foreground')}><X className={cn('w-5', 'h-5')} /></button>
              </div>
              ...
              <div className={`rounded-2xl overflow-hidden border bg-background/60 relative aspect-3/4 flex items-center justify-center transition-all duration-300 ${
                ...
                <video ref={videoRef} playsInline muted className={cn('w-full', 'h-full', 'object-cover')} />

                {/* Laser animation */}
                {scanStatus === "scanning" && (
                  <div className={cn('absolute', 'inset-x-0', 'bottom-0', 'h-40', 'bg-linear-to-t', 'from-background', 'via-background/80', 'to-transparent', 'z-80', 'pointer-events-none')} />
                )}

                {/* Target crop corner brackets */}
                {scanStatus === "scanning" && (
                  <div className={cn('absolute', '-inset-[1px]', 'bg-linear-to-b', 'from-transparent', 'to-background/90', 'z-80', 'pointer-events-none', 'rounded-[32px]')}>
                    <div className={cn('absolute', '-top-1', '-left-1', 'w-5', 'h-5', 'border-t-2', 'border-l-2', 'border-green-400', 'rounded-tl-md')} />
                    <div className={cn('absolute', '-top-1', '-right-1', 'w-5', 'h-5', 'border-t-2', 'border-r-2', 'border-green-400', 'rounded-tr-md')} />
                    <div className={cn('absolute', '-bottom-1', '-left-1', 'w-5', 'h-5', 'border-b-2', 'border-l-2', 'border-green-400', 'rounded-bl-md')} />
                    <div className={cn('absolute', '-bottom-1', '-right-1', 'w-5', 'h-5', 'border-b-2', 'border-r-2', 'border-green-400', 'rounded-br-md')} />
                  </div>
                )}

                {/* Status Badges */}
                {scanStatus === "scanning" && (
                  <div className={cn('absolute', 'top-4', 'left-4', 'z-20', 'flex', 'items-center', 'gap-2', 'px-3', 'py-1', 'rounded-full', 'bg-black/60', 'border', 'border-white/10', 'backdrop-blur-md')}>
                    <span className={cn('w-1.5', 'h-1.5', 'rounded-full', 'bg-green-400', 'animate-pulse')} />
                    <span className={cn('text-[10px]', 'font-black', 'text-white', 'uppercase', 'tracking-widest')}>Scanning</span>
                  </div>
                )}
                {scanStatus === "success" && (
                  <div className={cn('absolute', 'top-4', 'left-4', 'z-20', 'flex', 'items-center', 'gap-2', 'px-3', 'py-1', 'rounded-full', 'bg-green-500/20', 'border', 'border-green-500/30', 'backdrop-blur-md')}>
                    <span className={cn('w-1.5', 'h-1.5', 'rounded-full', 'bg-green-400')} />
                    <span className={cn('text-[10px]', 'font-black', 'text-green-400', 'uppercase', 'tracking-widest')}>Success</span>
                  </div>
                )}

                {scanStatus === "idle" && (
                  <div className={cn('absolute', 'inset-0', 'bg-background/80', 'flex', 'flex-col', 'items-center', 'justify-center', 'text-center', 'px-6', 'z-20')}>
                    <Camera className={cn('w-8', 'h-8', 'text-foreground/70', 'mb-3')} />
                    <p className={cn('text-sm', 'text-foreground/70')}>To scan room QR codes, allow camera permission.</p>
                    <button
                      type="button"
                      onClick={startScanner}
                      className={cn('mt-4', 'h-10', 'rounded-xl', 'bg-foreground', 'px-4', 'text-sm', 'font-semibold', 'text-background', 'hover:bg-foreground')}
                    >
                      Allow Camera Access
                    </button>
                  </div>
                ...
                {scanStatus === "starting" && (
                  <div className={cn('absolute', 'inset-0', 'bg-background/60', 'flex', 'items-center', 'justify-center', 'text-foreground/70', 'text-sm', 'font-semibold', 'z-20')}>Starting camera...</div>
                )}
                {scanStatus === "error" && (
                  <div className={cn('absolute', 'inset-0', 'bg-background/75', 'flex', 'flex-col', 'items-center', 'justify-center', 'text-center', 'px-6', 'z-20')}>
                    <Camera className={cn('w-6', 'h-6', 'text-red-400', 'mb-3')} />
                    <p className={cn('text-sm', 'text-red-300')}>{scanError ?? "Unable to scan QR"}</p>
                    <button
                      type="button"
                      onClick={startScanner}
                      className={cn('mt-4', 'h-9', 'rounded-lg', 'border', 'border-foreground/20', 'px-3', 'text-xs', 'font-semibold', 'text-foreground', 'hover:border-foreground/40')}
                    >
                      Retry Camera Access
                    </button>
                  </div>
              ...
              <p className={cn('mt-4', 'text-xs', 'text-foreground/60', 'text-center')}>Point your camera at the room QR code.</p>
            </div>
          </div>
        )}
