    ...
    >
      ...
      >
        ...
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[70vw] h-[70vw] bg-[radial-gradient(circle,var(--tw-gradient-stops))] from-violet-600/15 dark:from-violet-900/25 to-transparent mix-blend-screen animate-pulse duration-[8000ms] will-change-transform" />
          <div className="absolute top-[20%] right-[-20%] w-[80vw] h-[80vw] bg-[radial-gradient(circle,var(--tw-gradient-stops))] from-emerald-500/15 dark:from-emerald-900/25 to-transparent mix-blend-screen animate-pulse duration-[12000ms] delay-1000 will-change-transform" />
          <div className="absolute bottom-[-20%] left-[20%] w-[90vw] h-[90vw] bg-[radial-gradient(circle,var(--tw-gradient-stops))] from-blue-500/15 dark:from-blue-900/25 to-transparent mix-blend-screen animate-pulse duration-[10000ms] delay-500 will-change-transform" />
