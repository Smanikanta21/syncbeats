            ...
            {isLogin ? (
              ...
              >
                ...
                <form className="space-y-6" onSubmit={handleAuth}>
                  ...
                  <GoogleButton refEl={googleLoginButtonRef} />
                </form>
            ...
            /* ── SIGNUP FORM ── */
              ...
              >
                ...
                <form className="space-y-4" onSubmit={handleAuth}>
                  ...
                  <GoogleButton refEl={googleSignupButtonRef} />
                </form>
...
function GoogleButton({ refEl }: { refEl: React.RefObject<HTMLDivElement | null> }) {
  return (
    <div className="flex flex-col items-center gap-3 w-full my-4 py-2">
      ...
      <div
        ref={refEl}
        className="flex justify-center items-center w-full min-h-[44px] py-1"
      />
    </div>
  );
}
