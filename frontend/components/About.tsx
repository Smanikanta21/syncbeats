  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-6xl mx-auto group">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-transparent group-hover:bg-foreground/5 blur-[100px] transition-all duration-1000 rounded-full pointer-events-none -z-10" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter text-foreground">
                Built because <br />
                <span className="text-foreground/50">Speakers are Expensive.</span>
              </h2>
              <div className="space-y-6 text-foreground/50 text-lg md:text-xl leading-relaxed font-medium group-hover:text-foreground/70 transition-colors duration-700">
                <p>
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative w-72 h-72 md:w-96 md:h-96">
                {/* Silver rings */}
                <div className="absolute inset-0 rounded-full bg-foreground/5 group-hover:bg-foreground/10 filter blur-[60px] transition-all duration-1000" />
                <div className="absolute inset-4 rounded-full border border-foreground/5 group-hover:border-foreground/10 animate-[spin_20s_linear_infinite] transition-colors" />
                <div className="absolute inset-8 rounded-full border border-foreground/5 animate-[spin_15s_linear_infinite_reverse]" />
          ...
          <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-transparent group-hover:bg-foreground/5 rounded-full filter blur-[120px] pointer-events-none transition-colors duration-1000" />
        </motion.div>
      </div>
    </section>
  );
