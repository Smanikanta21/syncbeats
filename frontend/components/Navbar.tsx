  ...
  return (
    <div className="fixed top-4 sm:top-6 left-4 right-4 md:left-16 md:right-16 lg:left-32 lg:right-32 z-50 flex flex-col items-center pointer-events-none">
      <motion.nav 
        ...
        className="w-full max-w-5xl glass-panel bg-background/80 backdrop-blur-3xl rounded-full px-6 md:px-8 py-4 flex items-center justify-between pointer-events-auto shadow-2xl"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-full mt-4 max-w-sm glass-panel bg-background/90 backdrop-blur-3xl rounded-[2rem] p-6 flex flex-col gap-6 shadow-2xl pointer-events-auto md:hidden"
          >
